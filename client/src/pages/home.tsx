        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-3 gap-8 items-center">
            ...
            <div className="md:col-span-1 flex justify-center md:justify-end space-x-4">
              <a href="https://github.com/diff-digest/diff-digest" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-muted/50 hover:bg-muted transition-colors">
